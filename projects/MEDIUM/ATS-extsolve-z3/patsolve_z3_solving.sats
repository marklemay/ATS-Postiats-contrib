...
#define ATS_PACKNAME "PATSOLVE_Z3_SOLVING"
...
fun formula_cond ( f_cond: form, f_then: form, f_else: form) : form


fun formula_eqeq (s2e1: form, s2e2: form): form


fun formula_sizeof_t0ype (s2e_t0ype: form): form


fun func_decl_0 (name: string, res: sort): func_decl
fun func_decl_1 (name: string, arg: sort, res: sort): func_decl
fun func_decl_2 (name: string, a0: sort, a1: sort, res: sort): func_decl

fun func_decl_list (name: string, domain: sortlst, range: sort): func_decl

fun formula_fdapp_0(fd: func_decl): form
fun formula_fdapp_1(fd: func_decl, arg: form): form
fun formula_fdapp_2(fd: func_decl, a0: form, a1: form): form
fun formula_fdapp_list(fd: func_decl, args: formlst): form
...
fun smtenv_create(): smtenv
fun smtenv_destroy(env: smtenv): void

fun s2var_pop_payload(s2var): form
fun s2var_top_payload(s2var): form
fun s2var_push_payload(s2var, form): void


fun smtenv_add_s2var (env: !smtenv, s2v: s2var): void
fun smtenv_add_s2exp (env: !smtenv, s2e: s2exp): void
fun smtenv_add_h3ypo (env: !smtenv, h3p: h3ypo): void


fun formula_error_s2cst(s2c0: s2cst): form
fun formula_error_s2exp(s2e0: s2exp): form
...
fun formula_make_s2cst (env: !smtenv, s2c: s2cst): form
fun formula_make_s2cst_fresh (env: !smtenv, s2c: s2cst): form

fun formula_make_s2var (env: !smtenv, s2v: s2var): form
fun formula_make_s2var_fresh (env: !smtenv, s2v: s2var): form

fun formula_make_s2Var_fresh (env: !smtenv, s2V: s2Var, s2t: s2rt): form


fun formula_make_s2exp (env: !smtenv, s2e: s2exp): form
fun formulas_make_s2explst (env: !smtenv, s2es: s2explst): formlst
fun formulas_make_labs2explst (env: !smtenv, ls2es: labs2explst): formlst

fun formula_make_s2cst_s2explst (env: !smtenv, s2c: s2cst, s2es: s2explst): form
...
fun s2cfun_initize_s2cinterp(s2c: s2cst): void
...
fun smtenv_formula_solve(!smtenv, form): Z3_lbool
