...
typedef jsnvlst = List0(jsonval)
typedef jsnvopt = Option(jsonval)
vtypedef jsnvopt_vt = Option_vt(jsonval)

fun jsonval_get_field (jsonval, string): jsnvopt_vt
...
fun parse_tyreckind (jsnv: jsonval): tyreckind

fun{a:t@ype} parse_list (jsnv: jsonval, f: jsonval -> a): List0(a)

fun{a:t@ype} parse_option (jsnv: jsonval, f: jsonval -> a): Option(a)
...
fun the_s2rtdatmap_get(): s2rtdatlst
